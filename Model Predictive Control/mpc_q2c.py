...
def cost_function(a, X):
    ...
    for i in range(Np):
        ...
        E_bat, v, t, x = X
        J += 10 * a[i]**2
        J += (v - vdes)**2      # penalize deviation from desired velocity
...
# save figure
plt.savefig("mpc_results_2c.png")

# save the variables with pickle
with open('mpc_results_2c.pkl', 'wb') as f:
